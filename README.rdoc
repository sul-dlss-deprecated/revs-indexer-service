...
rails c
  ...
  collection_data=indexer.get_collection_data(purl.collection_druids) # will get collections this pid belongs to

  mapper = RevsMapper.new(pid,mods,purl,collection_data)
